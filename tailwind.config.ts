...
import wexPreset from "@wexinc-healthbenefits/ben-ui-kit/tailwind-preset";
...
const config: Config = {
  ...
  theme: {
    extend: {
      // Message Center: show desktop layout (sidebar + table) at 400px+ so it's not stuck in mobile
      screens: { mc: "400px" },
      colors: {
